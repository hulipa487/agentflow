...
- **HTTP** — `http.request` / `os.env` Lua ops with scheme validation, body cap, secret-header redaction, and an address guard that refuses private, loopback, link-local and reserved destinations.
